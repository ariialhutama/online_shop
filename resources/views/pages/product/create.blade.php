                    ...
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Stock</label>
                                <input type="number"
                                    cnlass="form-control @error('stock')
                                is-invalid
                            @enderror"
                                    name="stock">
                                @error('stock')
                            ...
                            {{-- <div class="form-group mb-0">
                                ...
                                <div class="selectedgroup selectedgroup-pills">
                                    <label class="selectedgroup-item">
                                        <input type="radio" name="status" value="1" class="selectedgroup-input"
                                            id="">
                                        <span class="selectedgroup-button">Active</span>
                                    </label>
                                    <label class="selectedgroup-item">
                                        <input type="radio" name="status" value="1" class="selectedgroup-input"
                                            id="">
                                        <span class="selectedgroup-button">Inactive</span>
                                    </label>
                                </div>
                            </div> --}}
